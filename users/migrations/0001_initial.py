    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', django_resized.forms.ResizedImageField(blank=True, crop=None, default='uploads\\profile\\default.jpg', force_format=None, keep_meta=True, quality=-1, scale=None, size=[500, 500], upload_to=users.models.content_file_name)),
