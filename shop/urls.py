...
urlpatterns = [
    ...
    path('<slug:business_slug>/<slug:branch_slug>/reviews/', views.reviews, name='reviews'),
    path('<slug:business_slug>/<slug:branch_slug>/contact/', views.contact, name='contact'),
    ...
    path('<slug:business_slug>/<slug:branch_slug>/<slug:product_slug>/detail/', views.product_detailed,
         name='product_detail'),
]
